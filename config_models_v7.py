...
#
# Tiers: v7-anthropic / v7-google / v7-openai / v7-managed (V7 routing abstractions)
# Modalities: capability modalities of the underlying model — "text", "image", "video", "audio"
#   (not file formats; the File property in V7 Go can accept PDFs, images, video, audio, etc.)
...
V7_MODELS = {
    ...
    "v7-go-agent-v2/claude-4-6-opus": {
        ...
        "multimodal": True, "modalities": ["text", "image"], "tier": "v7-anthropic",
    ...
    "v7-go-agent-v2/gemini-3-1-flash-lite": {
        ...
        "multimodal": True, "modalities": ["text", "image", "video", "audio"], "tier": "v7-google",
        "price_in": 0.0, "price_out": 0.0, "ctx": 1_000_000,
    ...
    "v7-go-agent-v2/gpt5": {
        ...
        "provider": "openai",
        "display": "GPT-5",
        "multimodal": True, "modalities": ["text", "image"], "tier": "v7-openai",
    ...
    "v7-go-agent-v2/o3-mini": {
        ...
        "provider": "openai",
        "display": "o3 Mini",
        "multimodal": False, "modalities": ["text"], "tier": "v7-openai",
        "price_in": 0.0, "price_out": 0.0, "ctx": 200_000,
        "v7_property_model": "o3_mini",
        "agent_template_json": "v7_go_agent_v2_template.json",
        "notes": "Text-only (no vision). STUB — set V7_GO_WORKSPACE_ID + V7_GO_AGENT_ID.",
        "input_field_slug": "document-text",
        "output_field_slug": "extracted-json"
    },
    ...
    "v7-go-agent-v2/ai-fast": {
        ...
        "provider": "v7",
        "display": "AI Fast",
        "multimodal": True, "modalities": ["text", "image"], "tier": "v7-managed",
